...
( function( document, $, undefined ) {
	...
	var hasShrink       = $body.hasClass( 'has-shrink-header' ),
		hasStickyShrink = $body.hasClass( 'has-sticky-shrink-header' ),
	...
	var bodyScroll = new Headroom( document.querySelector( 'body' ), {
		offset: 1,
		classes : {
			initial : 'headroom',
			pinned : 'pinned',
	...
	if ( hasReveal ) {
		...
		var headerScroll = new Headroom( document.querySelector( 'header' ), {
			offset: 256,
			tolerance: {
				down: 5,
				up: 15
	...
	// If doing reveal header.
		...
		// 		if ( 'down' === direction ) {
		// 			$window.trigger( 'maiHeaderConceal' );
		// 		}
		// 	}
		// });
		...
		// $window.on( 'maiThrottledScroll', function() {
		// 	var currentTop = $window.scrollTop();
		// 	maybeRevealHeader( currentTop );
		// 	previousTop = currentTop;
		// 	scrolling   = false;
		// });
		// function maybeRevealHeader( currentTop ) {
		// 	if ( previousTop - currentTop > scrollDelta ) {
		// 		$window.trigger( 'maiHeaderReveal' );
		...
		// 	// body lock scroll makes this not matter?!?
		// 	// if ( $body.hasClass( 'mai-menu-activated' ) ) {
		// 	// 	return;
		// 	// }
	...
	function doShrinkHeader() {
		...
		// 	}
		// });
		// $window.on( 'maiOnTop', function() {
		// 	if ( $window.width() <= 768 ) {
		// 		shrinkHeader();
		// 	});
		// });
		// $window.on( 'maiNotTop', function() {
		// 	if ( $window.width() > 768 ) {
		// 		shrinkHeader();
		// 	}
		// });
		// $window.on( 'maiToTop', function() {
		// 	if ( $window.width() > 768 ) {
		// 		unshrinkHeader();
		// 	}
		// });
