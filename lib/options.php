...
function mai_get_default_options() {
	...
	$defaults = array(
		...
		'boxed_elements'            => array( 'entry_singular', 'entry_archive', 'sidebar_widgets', 'sidebar_alt_widgets', 'author_box', 'after_entry_widgets', 'adjacent_entry_nav', 'comment_respond', 'comments', 'pings' ),
